...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        private Task ExceptionReceivedHandler(ExceptionReceivedEventArgs exceptionReceivedArgs)
        {
            var ex = exceptionReceivedArgs.Exception;
            var context = exceptionReceivedArgs.ExceptionReceivedContext;
